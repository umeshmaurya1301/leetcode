 ...
 *
 * Approach: Greedy: count every sign flip between consecutive differences — O(n) time, O(1) space.
 */
package arrays;

import java.util.*;

class LT_0376_Wiggle_Subsequence_2_GreedyDirectionChange {
    ...
    public static void main(String[] args) {
        LT_0376_Wiggle_Subsequence_2_GreedyDirectionChange sol = new LT_0376_Wiggle_Subsequence_2_GreedyDirectionChange();
