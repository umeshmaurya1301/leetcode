...
4021: ("Minimum Operations to Make a Rotated Palindrome I", "Medium", "https://leetcode.com/problems/minimum-operations-to-make-a-rotated-palindrome-i/"),
}
...
PACKAGES = {
    ...
    "heap":               ("Heap / Priority Queue", "Min-heap or max-heap driven algorithms — top-k, merge k sorted, Dijkstra-style expansion."),
